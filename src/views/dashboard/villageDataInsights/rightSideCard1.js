...
//   }, [selectedTaluk]);
  ...
  const defaultColDef3 = useMemo(() => ({
    ...
    return (
        <Card style={{ display: 'flex', flexDirection: 'column', alignItems: 'right',width:'360px', marginLeft:'140px' }}>
            <CardBody>
                ...
                <TabContent activeTab={activeList}>
                    <TabPane tabId='1'>
                        ...
                        <CardBody>
                            <div className="ag-theme-alpine" style={{ height: '360px',marginLeft:'-30px',marginRight:'-30px',marginBottom:'-16px' }}>
                                <AgGridReact
                                    ref={gridRef}
                                    rowData={rowData}
