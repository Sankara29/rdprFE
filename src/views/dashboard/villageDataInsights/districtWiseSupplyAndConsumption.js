...
console.log(filldata)
        fetchx(API_URL + `/getLineTankWisedata?session_id=${filldata.session_id}`)
    ...
    const columnDefs = useMemo(() => [
        ...
        { headerName: 'Tank ID', field: 'node_id', maxWidth: 138 },
        { headerName: 'Session ID', field: 'session_id', maxWidth: 138 },
        {
            headerName: 'Water Supplied(m³)', field: 'water_supplied', maxWidth: 160, wrapText: true,
        ...
        {
            headerName: 'Electricity Supplied (kWh)', field: 'energy_supplied', maxWidth: 110, wrapText: true,
