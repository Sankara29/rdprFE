...
//         },
//         {
//             headerName: 'Rvoltage', field: 'Rvoltage', maxWidth: 120, valueFormatter: (params) => {
//                 return params.value ? Number(params.value)?.toFixed(2) : '';
//             }
//         },
//         {
//             headerName: 'Yvoltage', field: 'Yvoltage', maxWidth: 120, valueFormatter: (params) => {
//                 return params.value ? Number(params.value)?.toFixed(2) : '';
//             }
//         },
//         {
//             headerName: 'Bvoltage', field: 'Bvoltage', maxWidth: 120, valueFormatter: (params) => {
//                 return params.value ? Number(params.value)?.toFixed(2) : '';
//             }
//         },
//         {
//             headerName: 'Rcurrent', field: 'Rcurrent', maxWidth: 120, valueFormatter: (params) => {
//                 return params.value ? Number(params.value)?.toFixed(2) : '';
//             }
//         },
//         {
//             headerName: 'Ycurrent', field: 'Ycurrent', maxWidth: 120, valueFormatter: (params) => {
//                 return params.value ? Number(params.value)?.toFixed(2) : '';
//             }
//         },
//         {
//             headerName: 'Bcurrent', field: 'Bcurrent', maxWidth: 120, valueFormatter: (params) => {
//                 return params.value ? Number(params.value)?.toFixed(2) : '';
//             }
//         },
//         {
//             headerName: 'cumwhimp', field: 'cumwhimp', maxWidth: 120, valueFormatter: (params) => {
//                 return params.value ? new Intl.NumberFormat('en-US').format(Number(params.value)?.toFixed(2)) : '';
//             }
//         },
//         {
//             headerName: 'cumwhexp', field: 'cumwhexp', maxWidth: 120, valueFormatter: (params) => {
//                 return params.value ? Number(params.value)?.toFixed(2) : '';
//             }
//         },
//         {
//             headerName: 'cumvahimp', field: 'cumvahimp', maxWidth: 125, valueFormatter: (params) => {
//                 return params.value ? new Intl.NumberFormat('en-US').format(Number(params.value)?.toFixed(2)) : '';
//             }
//         },
//         {
...
//         },
//         {
//             headerName: 'Ravgvoltage', field: 'Ravgvoltage', maxWidth: 135, valueFormatter: (params) => {
//                 return params.value ? Number(params.value)?.toFixed(2) : '';
//             }
//         },
//         {
//             headerName: 'Yavgvoltage', field: 'Yavgvoltage', maxWidth: 135, valueFormatter: (params) => {
//                 return params.value ? Number(params.value)?.toFixed(2) : '';
//             }
//         },
//         {
//             headerName: 'Bavgvoltage', field: 'Bavgvoltage', maxWidth: 135, valueFormatter: (params) => {
//                 return params.value ? Number(params.value)?.toFixed(2) : '';
//             }
//         },
//         {
//             headerName: 'Ravgcurrent', field: 'Ravgcurrent', maxWidth: 135, valueFormatter: (params) => {
//                 return params.value ? Number(params.value)?.toFixed(2) : '';
//             }
//         },
//         {
//             headerName: 'Yavgcurrent', field: 'Yavgcurrent', maxWidth: 135, valueFormatter: (params) => {
//                 return params.value ? Number(params.value)?.toFixed(2) : '';
//             }
//         },
//         {
//             headerName: 'Bavgcurrent', field: 'Bavgcurrent', maxWidth: 135, valueFormatter: (params) => {
//                 return params.value ? Number(params.value)?.toFixed(2) : '';
//             }
//         },
//         {
//             headerName: 'blockwhimp', field: 'blockwhimp', maxWidth: 135, valueFormatter: (params) => {
//                 return params.value ? new Intl.NumberFormat('en-US').format(Number(params.value)?.toFixed(2)) : '';
//             }
//         },
//         {
//             headerName: 'blockwhexp', field: 'blockwhexp', maxWidth: 135, valueFormatter: (params) => {
//                 return params.value ? Number(params.value)?.toFixed(2) : '';
//             }
//         },
//         {
//             headerName: 'blockvahimp', field: 'blockvahimp', maxWidth: 125, valueFormatter: (params) => {
//                 return params.value ? new Intl.NumberFormat('en-US').format(Number(params.value)?.toFixed(2)) : '';
//             }
//         },
//         {
//             headerName: 'blockvahexp', field: 'blockvahexp', maxWidth: 125, valueFormatter: (params) => {
//                 return params.value ? Number(params.value)?.toFixed(2) : '';
//             }
//         },
//     ], []);
...
//         },
//         {
//             headerName: 'cumwhimp', field: 'cumwhimp', maxWidth: 125, valueFormatter: (params) => {
//                 return params.value ? Number(params.value)?.toFixed(2) : '';
//             }
//         },
//     ], []);
...
//         },
//         {
//             headerName: 'cumKwhImp', field: 'cumKwhImp', maxWidth: 130, valueFormatter: (params) => {
//                 return params.value ? new Intl.NumberFormat('en-US').format(Number(params.value)?.toFixed(2)) : '';
//             }
//         },
//         {
...
//         },
//         {
//             headerName: 'mdwimp', field: 'mdwimp', maxWidth: 125, valueFormatter: (params) => {
//                 return params.value ? new Intl.NumberFormat('en-US').format(Number(params.value)?.toFixed(2)
//                 ) : '';
//             }
//         },
...
//         },
//         {
//             headerName: 'cumvahimp', field: 'cumvahimp', maxWidth: 130, valueFormatter: (params) => {
//                 return params.value ? new Intl.NumberFormat('en-US').format(Number(params.value)?.toFixed(2)
//                 ) : '';
//             }
//         },
//         {
//             headerName: 'cumvahexp', field: 'cumvahexp', maxWidth: 130, valueFormatter: (params) => {
//                 return params.value ? new Intl.NumberFormat('en-US').format(Number(params.value)?.toFixed(2)
//                 ) : '';
//             }
//         },
...
const OverView = () => {
    ...
    const columnDefsDaily = useMemo(() => [
        ...
        },
        {
            ...
            valueFormatter: (params) =>
                params.data.timeclock
                    ? Moment(params.data.timeclock).subtract(1, 'day').format('MMM-DD-YYYY')  // Format date and time
                    : 'N/A'  // Fallback in case of missing value
        },
