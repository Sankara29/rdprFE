...
const toggle = id => {
  ...
  useEffect(() => {
    // console.log("Clicked")
    fetchx('http://192.168.1.33:14676/getrestaurant?hotelID='+id)
  ...
  const onSubmit = (data) => {
    ...
    if (
      ...
      let res = fetchx("http://192.168.1.33:14676/addrestaurant", {
        method: "POST",
  ...
  return (
    ...
    <Accordion open={open} toggle={toggle}>
      <AccordionItem>
        <AccordionHeader targetId='1'>Add Restaurent Table</AccordionHeader>
        <AccordionBody accordionId='1'>
      {/* <CardHeader>
        <CardTitle tag="h4">Restaurent Table</CardTitle>
      </CardHeader> */}
      <CardBody>
          ...
          <div className="mb-1">
           ...
           Table ID
            ...
            <InputGroup className="input-group-merge">
              <InputGroupText
                className={classnames({
                  "is-invalid": data !== null && (data.tableId === null || !data.tableId.length)
                })}
              ></InputGroupText>
              <Controller
                id="tableId"
                ...
                render={({ field }) => (
                  ...
                  placeholder="Table Id"
                    ...
                    className={classnames("form-control", {
                      "is-invalid":
                        data !== null && (data.tableId === null || !data.tableId.length)
                    })}
                  />
                )}
              />
