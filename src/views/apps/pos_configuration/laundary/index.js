...
const toggle = id => {
  ...
  useEffect(() => {
    // console.log("Clicked")
    fetchx(API_URL+'/getlaundry?hotelID='+id)
  ...
  const onSubmit = (data) => {
    ...
    if (
      ...
      // console.log(spa);
      let res = fetchx(API_URL+"/addlaundry", {
        method: "POST",
  ...
  return (
    ...
    <Accordion open={open} toggle={toggle}>
      <AccordionItem>
        <AccordionHeader targetId='1'>Add Laundry</AccordionHeader>
        <AccordionBody accordionId='1'>
      {/* <CardHeader>
        <CardTitle tag="h4">Laundry</CardTitle>
      </CardHeader> */}
      <CardBody>
