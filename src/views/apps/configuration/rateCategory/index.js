...
let rateClassID = [
  fetchx(API_URL +'/getRateCategoryRateClassID?hotelID=1')
 ...
 const [open, setOpen] = useState('')
  ...
  const [columnDefs, setColumnDefs] = useState([
    ...
    {headerName: 'Description',field: 'description',cellStyle: {'text-align': 'center','background-color': 'pink'}, maxWidth: 140},         
       {headerName: 'rateClassID ',field: 'rateClass',cellStyle: {'text-align': 'center','background-color': '#F1E39B'}, maxWidth: 140},
  ...
  const updatedItem = JSON.stringify({            
    ...
    //  console.log(updatedItem)
     fetchx(API_URL+ `/updateRateCategory?id=${event.data.id}`, {
     method: 'PUT',
     body: updatedItem,
     headers: {
...
// console.log(updatedItem)
fetchx(API_URL+ `/updateRateCategory`, {
method: 'PUT',
body: updatedItem,
headers: {
'Content-type': 'application/json'
...
setPopUp(false)
fetchx(API_URL + '/getRateCategory?hotelID=1')
.then(result => result.json())
.then(rowData =>{
...
// console.log("oldValue",oldValue)
  ...
  const onSubmit = data => {
    ...
    if (data.rateCategory.length && data.description.length) {
        ...
        let res = fetchx(API_URL + "/addRateCategory", {
          method: "POST",
        ...
        <div className='mb-1'>
          ...
          <Col md='4' sm='12'>
              <div className='mb-1'>
                ...
                Rate Class ID <spam style={{color:'red'}}>*</spam>
                </Label>
                <Controller
                  id='rateClassID'
                  control={control}
