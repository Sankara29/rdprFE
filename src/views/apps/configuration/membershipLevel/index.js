...
const MembershipLevel = () => {
  ...
  const updatedItem = JSON.stringify({            
    ...
    //  console.log(updatedItem)
     fetchx(API_URL+`/updateMembershipLevels?id=${event.data.id}`, {
     method: 'PUT',
     body: updatedItem,
     headers: {
...
// console.log(updatedItem)
fetchx(API_URL+ `/updateMembershipLevels`, {
method: 'PUT',
body: updatedItem,
headers: {
'Content-type': 'application/json'
...
// console.log("oldValue",oldValue)
  ...
  useEffect(() => {
    fetchx(API_URL +'/getMembershipLevel?hotelID=1')
    .then(result => result.json())
  ...
  const onSubmit = data => {
    ...
    if (data.membershipLevel!== null && data.description !== null ) {
        ...
        let res = fetchx(API_URL +"/addmembershiplevel", {
          method: "POST",
