...
// ** Reactstrap Imports
import { Card, Form, Label, Button, CardBody, CardTitle, CardHeader, InputGroup,Col, Row,Input,Modal,ModalHeader,ModalBody  } from 'reactstrap'
...
const SubGroup = () => {
  ...
  const updatedItem = JSON.stringify({            
    ...
    //  console.log(updatedItem)
     fetchx(API_URL+`/updateSubGroups?id=${event.data.id}`, {
     method: 'PUT',
     body: updatedItem,
     headers: {
...
// console.log(updatedItem)
fetchx(API_URL+ `/updateSubGroups`, {
method: 'PUT',
body: updatedItem,
headers: {
'Content-type': 'application/json'
...
setPopUp(false)
fetchx(API_URL + '/getSubGroup?hotelID=1')
.then(result => result.json())
.then(rowData =>{
...
// console.log("oldValue",oldValue)
  ...
  const onSubmit = data => {
    ...
    if (data.subGroup!== null && data.description !== null && data.groupID !== null ) {
        ...
        let res = fetchx(API_URL +"/addSubGroup", {
          method: "POST",
